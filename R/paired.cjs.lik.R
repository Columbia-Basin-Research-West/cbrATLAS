...
#'
#' @param params.in List of likelihood MLE estimators (S,p,l) in a single vector (1 each for upper, lower release)
...
#' @param fix.1 vector of estimates greater than 1 that will be fixed to 1
#'
#' @return This function returns a negative log-likelihood
#' @export
#'
paired.cjs.lik=function(params.in,counts.in,num.period,use.hist,L.in=NULL,d.in=NULL,common.start=NULL,fix.1=NULL){
 ...
 if(!is.null(fix.1))
  {
    ...
    # okay as long as number of sites < 10
