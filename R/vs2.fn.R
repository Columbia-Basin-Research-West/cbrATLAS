...
#'
#' @description This function uses the point and standard estimates to get the adjust survival and standard error. default is no covariance between survivals
#'
#' @param s1 survival upper reach
#' @param s2 survival lower reach
#' @param se1 survival upper reach standard error
#' @param se2 survival lower reach standard error
#' @param se.in standard errors or variances being used for inputs, default = SE
#' @param se.output output of survival ratio point estimate with standard error or variance, default = SE
#'
...
## covariance is assumed equal to zero,so se2*se2 = 0
